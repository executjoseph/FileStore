...
APP_ID = int(os.environ.get("APP_ID", "24890303")) #Your API ID from my.telegram.org
API_HASH = os.environ.get("API_HASH", "94cf78d1e6883ecb10f32e31fc23cfe0") #Your API Hash from my.telegram.org
#--------------------------------------------

CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002755896210")) #Your db channel Id
OWNER = os.environ.get("OWNER", "Nkkwksl") # Owner username without @
OWNER_ID = int(os.environ.get("OWNER_ID", "7289855833")) # Owner id
#--------------------------------------------
